...
public class CreateOrUpdateEvents extends IStarBaseServelet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameterMap().containsKey("startEventDate")) {
			startEventDate = request.getParameter("startEventDate") != "" ? request.getParameter("startEventDate") : "";
		}
		if (request.getParameterMap().containsKey("endEventDate")) {
			endEventDate = request.getParameter("endEventDate") != "" ? request.getParameter("endEventDate") : "";
		}
		if (request.getParameterMap().containsKey("trainerID")) {
			trainerID = request.getParameter("trainerID") != "" ? Integer.parseInt(request.getParameter("trainerID"))
					: 0;
		}
		...
		if (request.getParameterMap().containsKey("sessionID")) {
			sessionID = request.getParameter("sessionID") != "" ? Integer.parseInt(request.getParameter("sessionID"))
					: 0;
		}
		...
		if (request.getParameterMap().containsKey("eventID")) {
			...
			ess.insertUpdateData(trainerID, hours, minute, batchID, eventType, eventDate, startTime, classroomID,
					AdminUserID, sessionID, eventID, associateTrainerID);
		}
		else
		{
			if (request.getParameterMap().containsKey("tabType")
				...
				EventSchedulerService ess = new EventSchedulerService();
				if (request.getParameterMap().containsKey("eventType")
						&& request.getParameter("eventType").equalsIgnoreCase("webinar")) {
					if (request.getParameterMap().containsKey("eventValue")) {
						...
						try {
							...
							for (int i = 0; i < array.size(); i++) {
								...
								ess.insertUpdateWebinarData(trainerID, hours, minute, batchID, eventType, eventDate,
										startTime, classroomID, AdminUserID, sessionID, eventID, associateTrainerID);
							}
				...
				if (request.getParameterMap().containsKey("eventType")
						&& request.getParameter("eventType").equalsIgnoreCase("remote_class")) {
					if (request.getParameterMap().containsKey("eventValue")) {
						JSONParser parser = new JSONParser();
						String eventDataDetails = request.getParameter("eventDataDetails");
						Object obj = null;
						try {
							...
							for (int i = 0; i < array.size(); i++) {
								...
								ess.insertUpdateRemoteClassData(trainerID, hours, minute, batchID, eventType, eventDate,
										startTime, classroomID, AdminUserID, sessionID, eventID, associateTrainerID);
							}
				...
				if (request.getParameterMap().containsKey("eventType")
						&& request.getParameter("eventType").equalsIgnoreCase("session")) {
				...
				} else if (request.getParameterMap().containsKey("eventType")
						&& request.getParameter("eventType").equalsIgnoreCase("assessment")) {
					...
					if (request.getParameterMap().containsKey("eventValue")) {
						...
						try {
							...
							for (int i = 0; i < array.size(); i++) {
								...
								asservice.insertDeleteData(trainerID, assessmentID, batchID, AdminUserID, eventDate,
										startTime, classroomID, associateTrainerID);
						...
						response.getWriter().print(asservice.singleAssessmentEvent(trainerID, eventType, batchID,
								assessmentID, eventDate, startTime, AdminUserID, classroomID, associateTrainerID));
					}
			...
			// dailyEvent else if
			else if (request.getParameterMap().containsKey("tabType")
					&& request.getParameter("tabType").equalsIgnoreCase("dailyEvent")) {
				...
				if (request.getParameterMap().containsKey("eventType")
					...
					if (request.getParameterMap().containsKey("eventValue")) {
						...
						response.getWriter()
								.print(ess.dailyEvent(trainerID, hours, minute, batchID, eventType, startEventDate,
			...
			// weeklyEvent else if
					...
					&& request.getParameter("tabType").equalsIgnoreCase("weeklyEvent")) {
				...
				if (request.getParameterMap().containsKey("eventType")
					...
					if (request.getParameterMap().containsKey("eventValue")) {
						...
						response.getWriter()
								.print(ess.weeklyEvent(trainerID, hours, minute, batchID, eventType, startEventDate,
										endEventDate, startTime, classroomID, AdminUserID, days, orgID,
										associateTrainerID));
					}
