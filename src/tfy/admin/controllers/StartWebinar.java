...
/**
 * Servlet implementation class StartWebinar
 */
@WebServlet("/start_webinar")
public class StartWebinar extends IStarBaseServelet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String getTrainerIdForWebinar = "select actor, item_id from task where project_id = (select project_id from task where id = "+taskId+") and item_type ='"+TaskItemCategory.WEBINAR_TRAINER+"'";
		...
		if(!trainerId.equalsIgnoreCase("") && !actor.equalsIgnoreCase(""))
		{
			if(trainerId.equalsIgnoreCase(actor))
			{
				...
				String findAllWebinarAttendees="select distinct  actor from task where project_id =(select project_id from task where id = "+taskId+") and item_type !='"+TaskItemCategory.WEBINAR_PRESENTOR+"'";
