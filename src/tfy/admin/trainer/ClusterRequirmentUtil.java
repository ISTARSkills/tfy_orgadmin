...
public class ClusterRequirmentUtil {
	...
	public void addRequirment(int pincodePin,int courseId,int trainerCount) {
		...
		//ViksitLogger.logMSG(this.getClass().getName(),"checkClutserReq--"+checkClutserReq);
		...
		if (data != null && data.size() != 0) {
			...
			for(HashMap<String, Object> item:data){
				...
				//ViksitLogger.logMSG(this.getClass().getName(),"updateClutserReq-"+updateClutserReq);
			...
			//ViksitLogger.logMSG(this.getClass().getName(),"checkCluster--"+checkCluster);
			...
			if (clutersdata != null && clutersdata.size() != 0) {
				for(HashMap<String, Object> item:clutersdata){
					...
					//ViksitLogger.logMSG(this.getClass().getName(),"createClutserReq-"+createClutserReq);
