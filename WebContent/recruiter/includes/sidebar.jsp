...
<nav class="navbar-default navbar-static-side" role="navigation">
	...
	<div class="sidebar-collapse">
		...
		<ul class="nav metismenu" id="side-menu">
			...
			<li><a href="<%=url%>"><i class="" aria-hidden="true"></i><span
					class="nav-label">DASHBOARD</span></a></li>
			<li><a href="<%=baseURL%>recruiter/jobs.jsp"><i class=""
					aria-hidden="true"></i> <span class="nav-label">JOBS</span></a></li>

			<li><a href="<%=baseURL%>recruiter/campaign.jsp"><i class=""
					aria-hidden="true"></i><span class="nav-label">CAMPAIGNS</span></a></li>
