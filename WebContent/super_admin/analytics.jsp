	...
	<div id="wrapper">
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row" style='margin: 0px'>
				<div class="card-box scheduler_margin-box">
					<ul class="nav nav-tabs tabs-bordered nav-justified">
						<li class="active"><a data-toggle="tab" id="tab_1"
							href="#tab1">Account</a></li>

						<li><a data-toggle="tab" id="tab_2" href="#tab2">Program</a></li>
