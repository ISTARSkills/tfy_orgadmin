...
<body>
	...
	<div class="reveal">
		...
		<div class="slides">
			<% String url = lessonServices.getAnyPath("media_url_path"); %>
			<%=lessonServices.lessonHTMLfromLessonXML(lesson_id).replaceAll("http://cdn.talentify.in/", url) %>
			...
			if(Reveal.getProgress() == 1){
				...
				$.ajax({
			        ...
			        success: function(result) {
                       ...
                       var url = fields[0];
                       setTimeout(function(){ window.location.replace(url+'='+result); }, 5000);
