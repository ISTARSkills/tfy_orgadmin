...
<link href="<%=basePath%>css/plugins/dataTables/datatables.min.css"
	rel="stylesheet">

<link href="<%=basePath%>css/plugins/select2/select2.min.css"
	rel="stylesheet">

<link href="<%=basePath%>css/plugins/fullcalendar/fullcalendar.min.css"
	rel="stylesheet">
<link
	href="<%=basePath%>css/plugins/fullcalendar/fullcalendar.print.css"
	rel='stylesheet' media='print'>

<link href="<%=basePath%>css/plugins/datapicker/datepicker3.css"
	rel="stylesheet">
<link href="<%=basePath%>css/plugins/clockpicker/clockpicker.css"
	rel="stylesheet">
<link
...
<link href="<%=basePath%>css/plugins/chosen/bootstrap-chosen.css"
	rel="stylesheet">
<link
	href="<%=basePath%>css/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css"
	rel="stylesheet">
