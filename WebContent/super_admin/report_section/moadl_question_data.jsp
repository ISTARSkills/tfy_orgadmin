...
<div class="ibox-content full-height-scroll modal-height"
	...
	<%
							...
							if(item.get("comprehensive_passage_text")==null || item.get("comprehensive_passage_text").toString().equalsIgnoreCase("") || item.get("comprehensive_passage_text").toString().contains("<p>null</p>")){
