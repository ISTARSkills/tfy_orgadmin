...
<%
	...
	if (!type.equalsIgnoreCase("Create")) {
		...
		for (HashMap<String, Object> item : data) {
			...
			internet_availability = item.get("internet_availability") != null
					? (boolean) item.get("internet_availability") : false;
				...
				<div class='row card-box'>
					...
					<form class="form-horizontal" action="../create_or_update_classroom" id="edit_class_model_form" method="post">
						...
						<div class="form-group">
							...
							%>
							<div class="col-lg-6">
								<label class="control-label">Organization *</label> <select class="form-control" name="org_id" data-validation="required">
