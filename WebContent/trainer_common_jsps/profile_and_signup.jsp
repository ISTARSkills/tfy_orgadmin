...
<style>
.btn-default.cluster-btn:hover, .btn-default.cluster-btn:focus,
	...
	<div class="ibox float-e-margins">
		<div class="ibox-content">
			<form class="form-horizontal" id="signup_form" action="<%=baseURL%><%=actionUrl%>" method="post">
				<input type="hidden" id="teaching_address" name="teaching_address" value=""> <input type="hidden" id="user_type" name="user_type" value="<%=userType%>">
				<%if(user!=null){ %>
				...
				<div class="col-lg-12">
					<div class="form-group" id="data_2">
						...
						<div class="input-group date col-sm-8">
							<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input name="dob" required type="text" class="form-control date_holder" value="<%if(user!=null && user.getUserProfile()!=null && user.getUserProfile().getDob()!=null){%><%=df.format(user.getUserProfile().getDob()) %><%}%>">
						</div>
					</div>
				</div>
				<div class="col-lg-12">
				...
				<div class="col-lg-12">
					<div class="form-group">
						...
						<div class="col-sm-8">
                           ...
                           {
                           	%>
								<option value="<%=user.getUserProfile().getAddress().getPincode().getPin()%>" selected><%=user.getUserProfile().getAddress().getPincode().getPin()%>
								</option>
								<%
                           }
				...
				<% 
					...
					<div class="form-group">
						<label class="col-sm-4 control-label">Batch Code(If Applicable):</label>
						<div class="col-sm-8">
				...
				<div class="col-lg-12">
					<label class="col control-label">Available Time Slots:</label> <input type="hidden" id="avaiable_time" required name="avaiable_time" value=""><br /> <br />
					<%
...
<div class="col-lg-6">
	...
	<%
      ...
      {
      	int cluseterId = (int)row.get("cluster_id");
      	clusterIds.add(cluseterId);
      }
      %>
	<div class="ibox-content">
		<table class="table table-inverse" id="cluster-table">
			<tbody>
				<%
               ...
               %>
				<tr>
                  ...
                  %>
					<td><button data-toggle="button" class="btn <%=css%> cluster-btn cluster_button" type="button" aria-pressed="true" data-id="<%=clusters.get(i).get("id")%>" style="margin-bottom: 5px; color: #1ab394; border-color: #1ab394; white-space: normal; word-break: break-word; max-width: 160px; min-width: 160px;"><%=clusters.get(i).get("cluster_name")%></button></td>
					<%
                  if (i % 2 == 2) {
                  %>
				</tr>
