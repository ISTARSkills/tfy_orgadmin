		...
		<div id="page-wrapper" class="gray-bg">
			...
			<%
				...
				if (request.getParameter("course_id") != null
					...
					List<HashMap<String, Object>> items = new ReportDetailService()
							.getAllSessions(Integer.parseInt(request.getParameter("batch_id")), 0, true);
					sessionCount = items.size();
					items = new ReportDetailService().getAllAssessments(Integer.parseInt(request.getParameter("batch_id")),
							0, true);
				...
				<div class="col-lg-12">
					...
					<div class="col-lg-5">
						<div class="ibox white-bg"
							style="padding-top: 5px; height: 582px !important;">
							...
							<div id="student_list_container">
								...
								<div class="col-lg-2">
									<div
										...
										<div
											data-target="#<%=item.get("student_id").toString() != null ? item.get("student_id").toString() : ""%>"
											class='holder-data'>
									...
									<div class="modal inmodal" id="student_card_modal"
										data-student_id="<%=item.get("student_id").toString()%>"
					...
					<div
						...
						<div class="tabs-container">
							<ul class="nav nav-tabs">
								<li class="active col-lg-6 text-center no-padding bg-muted"><a
									data-toggle="tab" href="#tab1">Sessions</a></li>
								<li class="col-lg-6 text-center no-padding bg-muted"><a
									data-toggle="tab" href="#tab2">Assessments</a></li>
							</ul>
									...
									events : {
										drilldown : function(e) {
											if (!e.seriesOptions) {
												...
												drilldowns = JSON
														.parse(sessionLevelData), series = drilldowns[e.point.name];
