...
gj.tree.methods = {
    ...
    appendNode: function ($tree, $parent, nodeData, level, position) {
        var i, $node, $newParent, $span, $img,
            data = $tree.data(),
            $node = $('<li data-xmlExist='+nodeData.data['xmlExist']+' data-title="'+nodeData.data['text']+'" id='+nodeData.data['item_id']+' data-id="' + nodeData.id + '" data-role="node" />').addClass(data.style.item),
