...
String stage_id = request.getAttribute("stage_id").toString();
...
<%}%>
					<a href="<%=baseURL%>StudentPaginatorPlacementOfficer?startIndex=<%=endIndex%>&stageID=<%=stage_id%>&vacancyID=<%=vacancyID%>&collegeID=<%=collegeID%>&companyID=<%=companyID%>"></a>	