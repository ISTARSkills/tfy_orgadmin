...
<div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row">
                                                <%
                                                String getExistingContext="";
                                                
                                                %>
                                                
                                                <div class="col-sm-12"><h3 class="m-t-none m-b">Add / Remove Learning Objectives</h3>
											    <p>Lesson can be mapped to learning objective. 
											     </p>
                                                    <form role="form">
                                                        <div class="form-group"><label>Lesson Title</label> <input type="text" class="form-control" 
                                                        disabled value="<%=lesson.getTitle()%>"></div>
