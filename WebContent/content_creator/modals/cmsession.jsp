				...
				<div class="container-fluid bd-example-row">
					<div class='row' style="margin-top: 10px;">
						...
						<div class='col-md-9 col-md-auto'>
							<input style="width: 100%" class="form-control" id='sessionModalTitle'>
						</div>
					</div>
					<hr>
					<div class='row'>
						...
						<div class='col-md-9 col-md-auto'>
							<textarea style="width: 100%" class="form-control" id='sessionModalDescription'></textarea>
						</div>
					</div>
					<hr>
					<div class='row'>
						...
						<div class='col-md-4 col-md-auto'>
							<button class="btn btn-sm btn-modal" style="margin-top: 22px" id='saveSession'>Save
								Changes</button>
						</div>
					</div>
				</div>
