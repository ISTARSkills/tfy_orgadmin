	...
	<div class="modal-content custom-event-container">
		<div class="modal-header custom-event-modal-header">
			<div class="container">
				<div class="row">
					<div class="col-md-2">
						<img alt="image" class="img-thumbnail-medium" src="<%=AppProperies.getProperty("media_url_path") %><%=events.getImageUrl() %>">
					</div>
					<div class="col-md-10">
						<div class="row">
							<div class="col-md-10">
								<div class="row custom-no-margins">
									<img src="/assets/images/icons_8_clock2.png" srcset="/assets/images/icons_8_clock2.png 2x, /assets/images/icons_8_clock3.png 3x" class="icons8-clock">
									<h1 class="am-hrs custom-no-margins"><%=events.getTime() %></h1>
									<img src="/assets/images/icons_8_empty_hourglass2.png" srcset="/assets/images/icons_8_empty_hourglass2.png 2x, /assets/images/icons_8_empty_hourglass3.png 3x" class="icons8-empty_hourglass">
									<h1 class="am-hrs custom-no-margins"><%=events.getDuration() %>
										Hrs
									</h1>
								</div>
							</div>
							<div class="col-md-2">
								<button type="button" class="close float-right custom-close-modal" data-dismiss="modal" aria-label="Close">X</button>
							</div>
						</div>
						<div class="row m-0">
							<h1 class="custom-modal-header-trainer popover-dismiss" data-toggle="popover" title="Sessions" data-trigger="hover" data-placement="bottom" data-content="<%=events.getSessionName()%>">
							...
							<div class="custom-oval-icon-blue">
								<img src="/assets/images/completed_shape3.png" srcset="/assets/images/completed_shape2.png 2x, /assets/images/completed_shape3.png 3x" class="completed-icon">
							</div>
							<%
											break;
							...
							<div class="custom-oval-icon-red">
								<img src="/assets/images/icons_8_video_call3.png" srcset="/assets/images/icons_8_video_call2.png 2x, /assets/images/icons_8_video_call3.png 3x" class="video-icon">
							</div>
							<%
											break;
						...
						<div class="row m-0">
							<div class="col-md-4">
								<div class="row">
									<h4 class="modal-info-header mr-1 mb-0">Role</h4>
									<h4 class="modal-info-content mb-0"><%=events.getCourseName() %></h4>
								</div>
							</div>
							<div class="col-md-4">
								<div class="row">
									<h4 class="modal-info-header mr-1 mb-0">Group</h4>
									<h4 class="modal-info-content mb-0"><%=events.getGroupName() %></h4>
								</div>
							</div>
							<div class="col-md-4">
								<div class="row">
									<h4 class="modal-info-header mr-1 mb-0">Trainer</h4>
									<h4 class="modal-info-content mb-0"><%=events.getTrainer().getTrainerName() %></h4>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="modal-body p-0 custom-event-modal-body">
			<div class="container px-0">
				<ul class="nav nav-tabs" style="flex-wrap: nowrap;">
					<li class="nav-item nav-item-modal-box m-0"><a class="nav-link nav-modal-text active p-0 " data-toggle="tab" href="#presentation" role="tab">Presentation</a></li>
					<li class="nav-item nav-item-modal-box m-0"><a class="nav-link nav-modal-text  p-0" data-toggle="tab" href="#trainerinfo" role="tab">Trainer Info</a></li>
					<li class="nav-item nav-item-modal-box m-0"><a class="nav-link nav-modal-text p-0" data-toggle="tab" href="#attendance" role="tab">Attendance</a></li>
					<li class="nav-item nav-item-modal-box m-0"><a class="nav-link nav-modal-text p-0" data-toggle="tab" href="#feedback" role="tab">Feedback</a></li>
					<li class="nav-item nav-item-modal-box m-0"><a class="nav-link nav-modal-text p-0" data-toggle="tab" href="#assessment" role="tab">Assessment</a></li>
					<li class="nav-item nav-item-modal-box m-0"><a class="nav-link nav-modal-text p-0" data-toggle="tab" href="#sessionlog" role="tab">Session Log</a></li>

				</ul>
			</div>
			<div class="tab-content custom-tab-content-size">

				<div class="tab-pane text-center active " id="presentation" role="tabpanel">

					<%if(events.getLogs() != null && events.getLogs().size() !=0){  %>
					<img alt="NO PRESENTATION" src="/ScreenShot?current_slide_id=<%=events.getLogs().get(events.getLogs().size()-1).getSlideId() %>&lesson_id=<%=events.getLogs().get(events.getLogs().size()-1).getLessonId() %>" style="width: 99%; height: 50vh">
					<%}else{ %>
				...
				<div class="tab-pane p-5 " id="trainerinfo" role="tabpanel">
					<div class="card trainerinfo-card">
						<div class="card-block">
							<div class="row">
								<div class="col-md-3">
									<img alt="image" src="<%=events.getTrainer().getImageUrl() !=null ? (events.getTrainer().getImageUrl().startsWith("http") ? events.getTrainer().getImageUrl() : AppProperies.getProperty("media_url_path") + events.getTrainer().getImageUrl()): ""  %>" class="trainer-info-img">
								</div>
								<div class="col-md-9">
									...
									<div class="row m-0 mt-3">
										...
										<p class="stars float-right m-0">
											...
											<%
																...
																%><i class='trainer-dash-star fa fa-star-o  mx-2'></i><i class='trainer-dash-star fa fa-star-o  mx-2'></i><i class='trainer-dash-star fa fa-star-o  mx-2'></i><i class='trainer-dash-star fa fa-star-o  mx-2'></i><i class='trainer-dash-star fa fa-star-o  mx-2'></i>
											<%
																	}
																%>
										</p>
									...
									<div class="row m-0 mt-3">
										...
										<h4 class="trainerinfo-type-value mb-0"><%=events.getTrainer().getTotalHoursTaught()!=null ?events.getTrainer().getTotalHoursTaught():0%>
											Hrs
										</h4>
									</div>
								</div>
					...
					<div class="card trainerinfo-card mt-5">
						<div class="card-block">
							<div class="row">
								<div class="col-md-3">
									<img alt="image" src="<%=events.getAssociateTrainer().getImageUrl() !=null ? (events.getAssociateTrainer().getImageUrl().startsWith("http") ? events.getAssociateTrainer().getImageUrl() : AppProperies.getProperty("media_url_path") + events.getAssociateTrainer().getImageUrl()): ""%>" class="trainer-info-img">
								</div>
								<div class="col-md-9">
									...
									<div class="row m-0 mt-3">
										<h4 class="trainerinfo-type-name mb-0">Total Hours Taught</h4>
										<h4 class="trainerinfo-type-value mb-0"><%=events.getAssociateTrainer().getTotalHoursTaught()!=null ?events.getAssociateTrainer().getTotalHoursTaught():0%>
											Hrs
										</h4>
									</div>
								</div>
						...
						<div class="trainerinfo-label text-center">
							<h3 class="trainerinfo-label-text text-center">Assistant Trainer</h3>
						</div>
					</div>
									...
									<div class="attendance-scroll custom-scroll-holder p-3">
										...
										<div class="row m-0 py-1">
											<div class="col-md-2 px-0 pr-3">
												<img class="attendance-user-img-small" alt="image" src="<%=events.getEventAttendance().getPresentStudents().get(i).getImageUrl() != null
							...
							<div class="card attendance-card-size">
								<div class="card-block">
									...
									<div class="attendance-scroll custom-scroll-holder p-3">
										...
										<div class="row m-0 py-1">
											<div class="col-md-2 px-0 pr-3">
												<img class="attendance-user-img-small" alt="image" src="<%=events.getEventAttendance().getAbsentStudents().get(i).getImageUrl() != null
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="float-right" style="position: relative">
								<a class="attendance-card-count show-more" style="cursor: pointer;"><u>Show more</u></a>
							</div>
							<%}%>
				...
				<div class="tab-pane p-4" id="assessment" role="tabpanel" style="height: 385px;">
					<div class="card">
						<div class="card-block px-4 pt-4">
							...
							<%if(events.getLearningObjCovered()!=null && events.getLearningObjCovered().size()>0){%>
							<ul class="assessment-card-content">
								<% for(String los : events.getLearningObjCovered()){%>
								<li><%=los %></li>
							...
							<%} else{ %>
							<p class="assessment-card-content">No Learning Objective Covered</p>
							<%} %>
				...
				<div class="tab-pane px-5 py-4 event-session-holder custom-scroll-holder" id="sessionlog" role="tabpanel">
						...
						<div class="card-block">
							<div class="row m-0 p-3">
								...
								<div class="col-md-6 p-0">
									<div class="row m-0 float-right">
										<div class="session-log-slidetime">Total Time Spent on Slide :</div>
							...
							<div class="p-3">
								<div class="row m-0 mb-1">
									...
									<h4 class="event-session-log-desc m-0"><%=events.getLogs().get(i).getSlideTitle() != null && events.getLogs().get(i).getSlideTitle().length() > 0? (events.getLogs().get(i).getSlideTitle().length()>70 ? events.getLogs().get(i).getSlideTitle().substring(0, 70)+"...":events.getLogs().get(i).getSlideTitle()):"N/A" %>
										(Id :<%=events.getLogs().get(i).getSlideId() != null ? events.getLogs().get(i).getSlideId():"N/A" %>)
									</h4>
								</div>
								<div class="row m-0 mb-1">
									<h4 class="event-session-log-title m-0">Lesson Title</h4>
									<h4 class="event-session-log-desc m-0"><%=events.getLogs().get(i).getLessonTitle() != null && events.getLogs().get(i).getLessonTitle().length() > 0? (events.getLogs().get(i).getLessonTitle().length()>70 ? events.getLogs().get(i).getLessonTitle().substring(0, 70)+"...":events.getLogs().get(i).getLessonTitle() ):"N/A" %>
										(Id :<%=events.getLogs().get(i).getLessonId() != null ? events.getLogs().get(i).getLessonId():"N/A" %>)
									</h4>
								</div>
								<div class="row m-0 mb-1">
									<h4 class="event-session-log-title m-0">Session Title</h4>
									<h4 class="event-session-log-desc m-0"><%=events.getLogs().get(i).getSesssionTitle() != null && events.getLogs().get(i).getSesssionTitle().length() > 0? (events.getLogs().get(i).getSesssionTitle().length()>70?events.getLogs().get(i).getSesssionTitle().substring(0, 70)+"..." : events.getLogs().get(i).getSesssionTitle()):"N/A" %>
										(Id :<%=events.getLogs().get(i).getSessionId() != null ? events.getLogs().get(i).getSessionId():"N/A" %>)
									</h4>
								</div>
							</div>
						</div>
					...
					<div class="card-block px-4 pt-4">
						<h1 class="assessment-card-title mt-0">No Events Session Log Found.</h1>
