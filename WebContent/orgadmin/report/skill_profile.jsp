	...
	<div class="jumbotron gray-bg">
		...
		<div class="container">
			...
			<div class="row ">
				...
				<div class="col-9">
					<div class="card custom-skill-tree ml-5 custom-scroll-holder custom-scroll-holder" style="overflow-y: auto;">
	...
	$(document).ready(function() {
		...
		function getSkillsfunction(course_id){
			...
			$("#skillTreeHolder").empty();
			 ...
			 $('.custom-skill-tree').parent().css('padding-left','43px');
