								...
								<div class="col-lg-3 white-bg no-borders whit-bg-schedular"
									...
									<div class="tabs-container">
										...
										<div class="tab-content">
											...
											<jsp:include page="./scheduler/single_event.jsp"></jsp:include>
											<jsp:include page="./scheduler/daily_event.jsp"></jsp:include>
											<jsp:include page="./scheduler/weekly_event.jsp"></jsp:include>
