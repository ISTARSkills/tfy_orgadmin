...
<title>Admin Portal | UserBatch Dashboard</title>
							...
							<div class="col-lg-12">
						        <div class="ibox float-e-margins">
									...
									<div class="ibox-content">
										...
										%>
										<%=(new DatatableUtils()).getReport(214, conditions, ((IstarUser) request.getSession().getAttribute("user")), "NONE").toString()%>
									</div>
						        </div>
						    </div>
						</div>
						        ...
						        <div class="ibox float-e-margins">
									...
									<div class="ibox-content">
										...
										<%
											...
											conditions.put("user_id", user_id+"");
										%>
										<%=(new DatatableUtils()).getReport(213, conditions, ((IstarUser) request.getSession().getAttribute("user")), "NONE").toString()%>
									</div>
						        </div>
						    </div>
						</div>
