	                    ...
	                    <div class="ibox">
	                        <div class="ibox-content">
	                           ...
	                           <!--  <div class="input-group search-bar">
	                                <input type="text" placeholder="Start typing to search the session of interest " class="input input-sm form-control">
	                            ...
	                            <ul class="sortable-list connectList agile-list ui-sortable" id="todo">
	                                ...
	                                <%
	                                		ArrayList<HashMap<String , Object>> lesson_list = orgadminUtil.getSessionListInCourse(course);
											for (HashMap<String , Object> lesson : lesson_list) {
									%>
		                                <li class="<%=lesson.get("status").toString().toLowerCase() %>" id="<%=lesson.get("lesson_id")%>"> <label><%=lesson.get("title")%></label>
	                ...
	                <div class="col-sm-9">
							...
							<div class="col-lg-12 active">
						        <div class="ibox float-e-margins ">
									<div class="ibox-title">
										<h5>Batches associated with this course</h5>
									...
									<div class="ibox-content">
										<div class="project-list">
											<table class="table table-hover">
												<tbody>
													<%
														out.println(util.PrintBatchList(course, baseURL).toString());
													%>
												</tbody>
											</table>
										</div>
						...
						<div class="row">
							<div class="col-lg-12">
						        <div class="ibox float-e-margins">
									<div class="ibox-title">
										<h5>Trainers associated with this course</h5>
										<div class="ibox-tools">
										<a href="#modal-form" data-toggle="modal"	class="btn btn-primary btn-xs right">Add more trainers</a>
											<a class="collapse-link">
												<i class="fa fa-chevron-up"></i>
											</a>
										</div>
									...
									<div class="ibox-content" style="display: none;">
											...
											%>
											<%=dtUtils.getReport(195, conditions, ((IstarUser) request.getSession().getAttribute("user")), "NONE").toString()%>
									</div>
						        </div>
						    </div>
						</div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row">
                                            <h2 >Add /Remove trainers to the course</h2>
                                                <div class="col-sm-12 b-r">
                                                
												<form role="form" action="/add_trainer_course" post="GET">
												<input type="hidden" name="course_id" value="<%=course.getId()%>">
												<%
												OrganizationUtils orgUtil =	new OrganizationUtils();
												ArrayList<Integer> already_added = orgUtil.getTraineravailableForCourse(course);
												List<HashMap<String, Object>> trainers = orgUtil.getAllTrainers();
												for(HashMap<String, Object> row: trainers)
												{
												...
												<%
												if(already_added.contains(id))
												{
												%>
												<input type="checkbox" class="i-checks" value="<%=id %>" name="stu_id" checked="">
												...
												{	
												%>
												<input type="checkbox" class="i-checks" value="<%=id %>" name="stu_id">  
												<%= name%> (<small><%=email %></small>)  
												<%
												}
												%>
                                        		...
                                        		%>
                                                <div>
                                                <button class="btn btn-sm btn-primary pull-left m-t-n-xs" type="submit"><strong>Add / Remove</strong></button>
                                                </div>
                                                    </form>
                                                </div>
                                        </div>
						...
						<div class="row">
							<div class="col-lg-12">
						        <div class="ibox float-e-margins">
									<div class="ibox-title">
										<h5>Events associated with this course</h5>
										<div class="ibox-tools">
						...
						<div class="col-lg-9">
							<p id="batchName" class="batchName"></p></div>
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label">Org Name</label>
						<div class="col-lg-9">
							<p id="orgName" class="orgName">xyz</p></div>
						</div>
												<div class="form-group">
						<label class="col-lg-3 control-label">Classroom</label>
						<div class="col-lg-9">
							<p id="class_room" class="class_room">xyz</p></div>
							
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label">Duration</label>
						<div class="col-lg-9">
							<p id="duration" class="duration">xyz</p></div>
						</div>
						
						<div class="form-group">
							<label class="col-lg-3 control-label">Trainer</label>
						<div class="col-lg-9">
							<p id="trainer" class="trainer">xyz</p></div>
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label">Status</label>
						<div class="col-lg-9">
							<p id="status" class="status">xyz</p></div>
						</div>
	...
	<%%>
		$(document).ready(function() {
			...
			$('#calendar').fullCalendar({
				...
				events : [ 
<%List<HashMap<String, Object>> res = util.getEventPerCourse(course);
int count = 0;
